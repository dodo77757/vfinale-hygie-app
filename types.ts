...
export interface SessionRecord {
  ...
  plannedSessionId?: string; // "ID de la session planifiée dans le calendrier (si liée)"
}
...
export interface UserProfile {
  ...
  programStatus?: 'none' | 'generating' | 'ready'; // "Statut de génération du programme"
...
export interface PlannedSession {
  ...
  status?: 'planned' | 'completed' | 'missed'; // Statut de la session
  workoutPlan?: WorkoutPlan; // Plan d'entraînement associé (optionnel)
  completedAt?: string; // Date de complétion (ISO string)
}
